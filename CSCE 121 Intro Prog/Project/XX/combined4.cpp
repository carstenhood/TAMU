...
search_button(Point(270,460), 150, 50, "Search All", cb_search),
clear_button(Point(270,530), 150, 25, "Clear Display", cb_clear),
...
add_title(Point(300,100), 150, 25, "Title:"),
add_poster(Point(300,170), 150, 25, "File name of poster:"),
add_year(Point(300,240), 150, 25, "Year of creation:"),
add_actors(Point(300,310), 150, 25, "Enter actor and file name of picture:\nEx.: mattdamon.jpg Matt Damon, \ncharliesheen.jpg Charlie Sheen"),
add_tags(Point(300,380), 150, 25, "Enter tags: \nEx.: romance, comedy, drama"),

create_button(Point(300,450), 70, 25, "Create", cb_create),
end_edit_button(Point(380,450), 70, 25, "Done", cb_end_edit),
update_button(Point(300,450), 70, 25, "Update", cb_update),
...
rows_text(Point(display_x+display_width+20, h-270), "Movie Display Options"),
